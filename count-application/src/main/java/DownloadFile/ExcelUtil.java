...
public class ExcelUtil {
     ...
     * @return
     */
    protected static HSSFWorkbook getHSSFWorkbook(String sheetName, String[] title, List<List<String>> listList, HSSFWorkbook wb) {
     ...
     * @return HSSFWorkbook
     */
    public static HSSFWorkbook setContent(List<List<String>> listList, String fileName) {
        int i = 0;
      //初始化标题
        ...
        title[1] = "page number";
        //创建HSSFWorkbook
        HSSFWorkbook wb = ExcelUtil.getHSSFWorkbook(fileName, title, listList, null);
        return wb;
    }
